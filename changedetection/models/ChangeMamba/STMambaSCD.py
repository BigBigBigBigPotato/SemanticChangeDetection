...
from MambaCD.changedetection.models.Changer_backbone import Backbone_VSSM_AD,Aggregation_distribution,SpatialExchange,ChannelExchange
...
class STMambaSCD(nn.Module):
    def __init__(self, output_cd, output_clf, pretrained,  **kwargs):
        ...
        # self.encoder = Backbone_VSSM_AD(out_indices=(0, 1, 2, 3), pretrained=pretrained,
        #                                 interaction=(None,
        #                                              SpatialExchange(),
        #                                              ChannelExchange(),
        #                                              ChannelExchange()),
